...
export function ContactAssuranceStrip() {
  return (
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#d4af37]/40 bg-[#fbf6ee] px-3.5 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#8e653e] shadow-2xs mb-3">
              ...
              <span>COORDINATION STANDARDS</span>
            </div>
            <h2 className="font-heading text-3xl sm:text-4xl font-normal tracking-tight text-[#14233c]">
              Institutional Inquiries & <br />
              <span className="italic text-[#a07142]">Advisory Engagement</span>
            </h2>
          </div>
          <p className="text-sm text-[#596579] max-w-md font-normal leading-relaxed">
            We maintain dedicated channels for individual candidate questions, enterprise talent recruiters, and institutional university leadership.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl border border-[#e2dcce] bg-white p-7 shadow-xs hover:border-[#14233c] transition-all group flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#596579] leading-relaxed">
                Direct guidance for prospective interns on program selection, duration commitments, and prerequisite alignment.
              </p>
            </div>
          ...
          <div className="rounded-2xl border border-[#e2dcce] bg-white p-7 shadow-xs hover:border-[#14233c] transition-all group flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#596579] leading-relaxed">
                Partnerships with tech companies and agencies seeking verified internship graduates with documented proof-of-work dossiers.
              </p>
            </div>
            <div className="mt-6 pt-4 border-t border-[#ede7de] text-[11px] font-mono text-[#8e653e]">
          ...
          <div className="rounded-2xl border border-[#e2dcce] bg-white p-7 shadow-xs hover:border-[#14233c] transition-all group flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#596579] leading-relaxed">
                Departmental MoUs, curriculum integration, and academic credit recognition for colleges and universities.
              </p>
            </div>
            <div className="mt-6 pt-4 border-t border-[#ede7de] text-[11px] font-mono text-[#8e653e]">
