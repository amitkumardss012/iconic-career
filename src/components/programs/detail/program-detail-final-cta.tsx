...
interface ProgramDetailFinalCtaProps {
  program: Program
}

export function ProgramDetailFinalCta({ program }: ProgramDetailFinalCtaProps) {
  return (
      ...
      <div className="container-site relative z-10">
        <div className="mx-auto max-w-3xl text-center flex flex-col items-center">
          ...
          <h2 className="font-heading text-3xl sm:text-5xl md:text-6xl font-normal tracking-tight text-white leading-tight">
            Ready to Begin <br />
            <span className="italic text-[#c5a880]">{program.name}?</span>
          </h2>

          {/* Subtitle */}
          <p className="mt-5 text-base sm:text-lg text-[#cbd5e1] leading-relaxed max-w-2xl font-light">
            Reserve your placement in our upcoming cohort, select your duration commitment, and access your onboarding dossier.
          </p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            ...
            >
              <span>Enroll in {program.name}</span>
            ...
            >
              <span>Browse Other Programs</span>
            </Link>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl text-xs text-[#cbd5e1]">
            <div className="flex items-center justify-center gap-2">
              ...
              <span>Next Cohort: Starts 1st Monday</span>
            </div>
            <div className="flex items-center justify-center gap-2">
              <AwardIcon className="size-4 text-[#c5a880]" />
              <span>100% Verifiable Certificate</span>
            </div>
            <div className="flex items-center justify-center gap-2">
              <ShieldCheckIcon className="size-4 text-[#c5a880]" />
              <span>Dedicated Mentor Supervision</span>
            </div>
          </div>
        </div>
      </div>
