...
export function ProgramsHeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#faf8f5] pt-14 sm:pt-20 pb-12 sm:pb-16 border-b border-[#ede7de]">
      ...
      />
      <div className="absolute top-0 right-1/3 w-[700px] h-[350px] bg-radial from-[#f3e7d5]/50 via-transparent to-transparent blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-[#d4af37]/40 bg-[#fbf6ee] px-3.5 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#8e653e] shadow-2xs mb-4">
              ...
              <span>ACADEMIC DISCOVERY & CURRICULUM DIRECTORY</span>
            ...
            {/* Display Headline */}
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-[58px] font-normal leading-[1.06] tracking-tight text-[#14233c]">
              Industry-Calibrated Tracks. <br />
              <span className="italic text-[#a07142]">Built for Demonstrable Competency.</span>
            </h1>

            {/* Subparagraph */}
            <p className="text-sm sm:text-base text-[#596579] leading-relaxed max-w-2xl mt-4 font-normal">
              Select an intentional curriculum designed to pair academic instruction with supervised industry internship tracks, weekly milestone reviews, and verifiable credentials.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 lg:flex-col lg:items-end shrink-0">
            <div className="text-left lg:text-right hidden sm:block">
              <div className="text-[0.62rem] font-bold tracking-[0.22em] uppercase text-[#7388a1]">
                TRANSPARENT PRICING • SUPERVISED HOURS • QR LEDGER
              </div>
            </div>
            ...
            >
              <span>Begin Candidate Registration</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-6 border-t border-[#e2dcce]/80">
          <div className="rounded-xl border border-[#e2dcce] bg-white/80 p-3.5 flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10.5px] text-[#64748b]">Tech, Ops, Design & More</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-[#e2dcce] bg-white/80 p-3.5 flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-bold text-[#14233c] block">4–12 Weeks</span>
          ...
          <div className="rounded-xl border border-[#e2dcce] bg-white/80 p-3.5 flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10.5px] text-[#64748b]">Public Registry Audit</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-[#e2dcce] bg-white/80 p-3.5 flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-bold text-[#14233c] block">From ₹1,999</span>
              <span className="text-[10.5px] text-[#64748b]">All-Inclusive with Certificate</span>
            </div>
          </div>
        </div>
      </div>
