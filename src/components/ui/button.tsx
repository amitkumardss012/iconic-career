...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding font-medium tracking-[0.01em] whitespace-nowrap transition-[color,background-color,border-color,box-shadow,opacity] duration-200 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-navy-deep",
        outline:
          "border-primary/20 bg-transparent text-foreground hover:border-primary/40 hover:bg-paper-deep aria-expanded:bg-muted",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-[color-mix(in_oklch,var(--secondary),var(--foreground)_6%)]",
        ghost: "hover:bg-muted hover:text-foreground",
        inverse:
          "border-paper/25 bg-transparent text-paper hover:bg-paper/10",
        brass:
          "bg-brass text-navy hover:bg-[color-mix(in_oklch,var(--brass),white_12%)]",
        destructive:
      ...
      size: {
        ...
        xl: "h-12 min-h-12 gap-2 px-7 text-base",
        icon: "size-10",
